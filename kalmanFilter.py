...
class planeTrackingExample:
    ...
    def plotSimulationControlLawVariables(self):
        ...
        time = self.kfm.time
        axis = self.vwr["2D"][key].getAxis(0)
        axis.plot(time, self.kfm.sim[key]["FoM"]["X"], label="F/m - X", marker="o", ms=3, c="g")
        axis.set_xlabel("t")
        axis.set_ylabel("F/m - X")
        axis.legend()
        axis = self.vwr["2D"][key].getAxis(1)
        axis.plot(time, self.kfm.sim[key]["FoM"]["Y"], label="F/m - Y", marker="o", ms=3, c="g")
        axis.set_xlabel("t")
        axis.set_ylabel("F/m - Y")
        axis.legend()
        axis = self.vwr["2D"][key].getAxis(2)
        axis.plot(time, self.kfm.sim[key]["FoM"]["Z"], label="F/m - Z", marker="o", ms=3, c="g")
        axis.set_xlabel("t")
        ...
        axis.legend()
        axis = self.vwr["2D"][key].getAxis(6)
        axis.plot(time, self.kfm.sim[key]["roll"], label="roll", marker="o", ms=3, c="g")
        axis.set_xlabel("t")
        axis.set_ylabel("roll")
        axis.legend()
        axis = self.vwr["2D"][key].getAxis(7)
        axis.plot(time, self.kfm.sim[key]["pitch"], label="pitch", marker="o", ms=3, c="g")
        axis.set_xlabel("t")
        axis.set_ylabel("pitch")
        axis.legend()
        axis = self.vwr["2D"][key].getAxis(8)
        axis.plot(time, self.kfm.sim[key]["yaw"], label="yaw", marker="o", ms=3, c="g")
        axis.set_xlabel("t")
        axis.set_ylabel("yaw")
        axis.legend()
    ...
    def plotSimulationCovarianceVariables(self):
        ...
        axis = self.vwr["2D"][key].getAxis(0)
        axis.plot(time, self.kfm.sim[key]["X"], label="$P_{xx}$", marker="o", ms=3, c="g")
        axis.set_xlabel("t")
        axis.set_ylabel("$P_{xx}$")
        axis.legend()
        axis = self.vwr["2D"][key].getAxis(1)
        axis.plot(time, self.kfm.sim[key]["Y"], label="$P_{yy}$", marker="o", ms=3, c="g")
        axis.set_xlabel("t")
        axis.set_ylabel("$P_{yy}$")
        axis.legend()
        axis = self.vwr["2D"][key].getAxis(2)
        axis.plot(time, self.kfm.sim[key]["Z"], label="$P_{zz}$", marker="o", ms=3, c="g")
        axis.set_xlabel("t")
        axis.set_ylabel("$P_{zz}$")
        axis.legend()
        axis = self.vwr["2D"][key].getAxis(3)
        axis.plot(time, self.kfm.sim[key]["VX"], label="$P_{vxvx}$", marker="o", ms=3, c="g")
        axis.set_xlabel("t")
        axis.set_ylabel("$P_{vxvx}$")
        axis.legend()
        axis = self.vwr["2D"][key].getAxis(4)
        axis.plot(time, self.kfm.sim[key]["VY"], label="$P_{vyvy}$", marker="o", ms=3, c="g")
        axis.set_xlabel("t")
        axis.set_ylabel("$P_{vyvy}$")
        axis.legend()
        axis = self.vwr["2D"][key].getAxis(5)
        axis.plot(time, self.kfm.sim[key]["VZ"], label="$P_{vzvz}$", marker="o", ms=3, c="g")
        axis.set_xlabel("t")
        axis.set_ylabel("$P_{vzvz}$")
        axis.legend()
        axis = self.vwr["2D"][key].getAxis(6)
        axis.plot(time, self.kfm.sim[key]["AX"], label="$P_{axax}$", marker="o", ms=3, c="g")
        axis.set_xlabel("t")
        axis.set_ylabel("$P_{axax}$")
        axis.legend()
        axis = self.vwr["2D"][key].getAxis(7)
        axis.plot(time, self.kfm.sim[key]["AY"], label="$P_{ayay}$", marker="o", ms=3, c="g")
        axis.set_xlabel("t")
        axis.set_ylabel("$P_{ayay}$")
        axis.legend()
        axis = self.vwr["2D"][key].getAxis(8)
        axis.plot(time, self.kfm.sim[key]["AZ"], label="$P_{azaz}$", marker="o", ms=3, c="g")
        axis.set_xlabel("t")
    ...
    def plotSimulationKalmanGainVariables(self):
        ...
        time = self.kfm.sim[key]["T"]
        axis = self.vwr["2D"][key].getAxis(0)
        axis.plot(time, self.kfm.sim[key]["X"], label="$K_{xx}$", marker="o", ms=3, c="g")
        axis.set_xlabel("t")
        axis.set_ylabel("$K_{xx}$")
        axis.legend()
        axis = self.vwr["2D"][key].getAxis(1)
        axis.plot(time, self.kfm.sim[key]["Y"], label="$K_{yy}$", marker="o", ms=3, c="g")
        axis.set_xlabel("t")
        axis.set_ylabel("$K_{yy}$")
        axis.legend()
        axis = self.vwr["2D"][key].getAxis(2)
        axis.plot(time, self.kfm.sim[key]["Z"], label="$K_{zz}$", marker="o", ms=3, c="g")
        axis.set_xlabel("t")
        axis.set_ylabel("$K_{zz}$")
        axis.legend()
        axis = self.vwr["2D"][key].getAxis(3)
        axis.plot(time, self.kfm.sim[key]["VX"], label="$K_{vxvx}$", marker="o", ms=3, c="g")
        axis.set_xlabel("t")
        axis.set_ylabel("$K_{vxvx}$")
        axis.legend()
        axis = self.vwr["2D"][key].getAxis(4)
        axis.plot(time, self.kfm.sim[key]["VY"], label="$K_{vyvy}$", marker="o", ms=3, c="g")
        axis.set_xlabel("t")
        axis.set_ylabel("$K_{vyvy}$")
        axis.legend()
        axis = self.vwr["2D"][key].getAxis(5)
        axis.plot(time, self.kfm.sim[key]["VZ"], label="$K_{vzvz}$", marker="o", ms=3, c="g")
        axis.set_xlabel("t")
        axis.set_ylabel("$K_{vzvz}$")
        axis.legend()
        axis = self.vwr["2D"][key].getAxis(6)
        axis.plot(time, self.kfm.sim[key]["AX"], label="$K_{axax}$", marker="o", ms=3, c="g")
        axis.set_xlabel("t")
        axis.set_ylabel("$K_{axax}$")
        axis.legend()
        axis = self.vwr["2D"][key].getAxis(7)
        axis.plot(time, self.kfm.sim[key]["AY"], label="$K_{ayay}$", marker="o", ms=3, c="g")
        axis.set_xlabel("t")
        axis.set_ylabel("$K_{ayay}$")
        axis.legend()
        axis = self.vwr["2D"][key].getAxis(8)
        axis.plot(time, self.kfm.sim[key]["AZ"], label="$K_{azaz}$", marker="o", ms=3, c="g")
        axis.set_xlabel("t")
